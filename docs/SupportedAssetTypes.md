...
| PhysPreset             | ✅              | ✅              |                                                                                                                                                                |
| PhysConstraints        | ✅              | ✅              |                                                                                                                                                                |
| DestructibleDef        | ⁉️              | ❌              | It now dumps in a format similar to WeaponDef                                                                                                                                                               |
| XAnimParts             | ❌              | ❌              |                                                                                                                                                                |
...
| XGlobals               | ❌              | ❌              |                                                                                                                                                                |
| ddlRoot_t              | ❌              | ❌              |                                                                                                                                                                |
| Glasses                | ⁉️              | ❌              | Dumps only the name only for now.                                                                                                                                                               |
| EmblemSet              | ❌              | ❌              |                                                                                                                                                                |
...
| KeyValuePairs          | ✅              | ❌              |                                                                                                                   |
| VehicleDef             | ✅              | ✅              |                                                                                                                                                                |
| MemoryBlock            | ⁉️              | ❌              | Dumping is implemented as rawfiles. Their use is currently unknown.                                                                                                                                                               |
| AddonMapEnts           | ⁉️              | ❌              | MapEnts String can be exported. Binary data currently not.              |                                                                                                                                                          |
| TracerDef              | ✅              | ✅              |                                                                                                                                                                |
| SkinnedVertsDef        | ✅              | ❌              |                                                                                                                                                                |
